...
`)}}}),d={};((e,t)=>{for(var n in t)a(e,n,{get:t[n],enumerable:!0})})(d,{getOptionalRequestContext:()=>f,getRequestContext:()=>E}),_.exports=i(a({},"__esModule",{value:!0}),d),v(3010);var p=((e,t,n)=>(n=e!=null?x(O(e)):{},i(!t&&e&&e.__esModule?n:a(n,"default",{value:e,enumerable:!0}),e)))(w()),q=Symbol.for("__cloudflare-request-context__");function f(){let e=b[q];if((process?.release?.name==="node"?"nodejs":"edge")=="nodejs")throw Error(p.default`
		...
		`);return e}function E(){let e=f();if(!e)throw process?.env?.NEXT_PHASE==="phase-production-build"?Error(p.default`
			...
			`):Error("Failed to retrieve the Cloudflare request context.");return e}},u.__chunk_3010=()=>{},u);export{N as __getNamedExports};
