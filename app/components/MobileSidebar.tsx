...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/platform-pulse", icon: <span>📊</span>, label: "Platform Pulse", color: "text-blue-400" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/trophy-room", icon: <span>🪙</span>, label: "Trophy Room", color: "text-amber-400" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/sunday-zen", icon: <span>🧘</span>, label: "Sunday Zen", color: "text-emerald-400" },
      ...
      { href: "/sunday-funday", icon: <span>🎉</span>, label: "Sunday Funday", color: "text-yellow-400" },
