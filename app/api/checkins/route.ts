...
export async function POST(request: NextRequest) {
  try {
    ...
    const { 
      category = 'cigar',
      brand, product, rating, review, imageUrl, mood, smokeSpot, drinkPairing,
      // Cigar fields
      flavorNotes, drawRating, burnRating, aromaRating, smokeTimeMins,
      // Cannabis fields
      strainName, strainType, effects, thcPercent
    ...
    await db
      .prepare(`
        INSERT INTO checkins (
          id, user_id, category, brand, product, rating, review, image_url, mood, smoke_spot, drink_pairing,
